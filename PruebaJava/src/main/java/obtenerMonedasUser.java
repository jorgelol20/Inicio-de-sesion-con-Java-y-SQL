...
public class obtenerMonedasUser {
    public static String obtenerMonedas(String user) throws SQLException {
        int monedasUser = 0;
        ...
        while (resultSet.next()){
            ...
            if (usuario.equals(user)){
                monedasUser = resultSet.getInt("monedas");
            }
        }
...
// Cerrar el objeto ResultSet para liberar recursos y evitar posibles problemas de fuga de recursos.
        resultSet.close();
        return String.valueOf(monedasUser);
    }
}
