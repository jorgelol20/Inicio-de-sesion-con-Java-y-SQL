...
public class reducirMonedas {
    public static void reducir(String user, int monedas) throws SQLException {
        ...
        statement.executeUpdate("UPDATE USUARIOS SET MONEDAS = '"+monedas+"' WHERE USER = '"+user+"'");
